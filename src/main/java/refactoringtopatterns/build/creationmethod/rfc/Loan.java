...
import refactoringtopatterns.build.creationmethod.CapitalStrategyRCTL;
import refactoringtopatterns.build.creationmethod.CapitalStrategyRevolver;
...
public class Loan {
   ...
   private Loan(CapitalStrategy capitalStrategy,
    ...
    static Loan createTermLoan(double commitment, int riskRating, Date maturity) {
        return new Loan(commitment, riskRating, maturity,null);
    }

    static Loan createTermLoan(CapitalStrategy riskAdjustedCapitalStrategy, double commitment, double outstanding, int riskRating, Date maturity) {
